    ...
    switch (arch) {
      ...
      case "arm64":
        if (isMusl()) {
          ...
          localFileExisted = existsSync(join(__dirname, "sdk-napi-linux-x64-gnu/sdk-napi.linux-arm64-gnu.node"));
          
          console.log(`Localfile Existed: ${localFileExisted}, dir: ${__dirname}, check: ${join(__dirname, "sdk-napi-linux-x64-gnu/sdk-napi.linux-arm64-gnu.node")}`)
          try {
            if (localFileExisted) {
