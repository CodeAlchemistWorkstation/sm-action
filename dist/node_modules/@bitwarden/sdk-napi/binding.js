    ...
    switch (arch) {
      ...
      case "arm64":
        if (isMusl()) {
          ...
          console.log(`Localfile Existed: ${localFileExisted}, dir: ${__dirname}`)
          try {
            if (localFileExisted) {
          ...
          var correctPath = __dirname.replace("/sdk-napi", "")
          localFileExisted = existsSync(join(correctPath, "sdk-napi-linux-x64-gnu/sdk-napi.linux-arm64-gnu.node"));
          
          console.log(`Localfile Existed: ${localFileExisted}, dir: ${correctPath}, check: ${join(correctPath, "sdk-napi-linux-x64-gnu/sdk-napi.linux-arm64-gnu.node")}`)
          try {
            if (localFileExisted) {
              nativeBinding = require("../sdk-napi-linux-x64-gnu/sdk-napi.linux-arm64-gnu.node");
            } else {
...
const { LogLevel, BitwardenClient } = nativeBinding;
